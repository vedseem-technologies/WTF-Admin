...
const OccasionDetail = () => {
  ...
  const occasion = Array.isArray(occasions)
    ? occasions.find((o) => o._id === id)
    : null;
      ...
      <div className="page-header">
        <div className="page-header-content">
          ...
          <p className="page-description">
            Manage menu items for this occasion
          </p>
        </div>
      </div>
        ...
        {totalSelected > 0 && (
          <div className="alert alert-info" style={{ marginTop: "24px" }}>
            ...
            >
              ...
              {selectedMainCourse.length} | Desserts: {selectedDesserts.length}{" "}
