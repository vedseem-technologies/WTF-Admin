...
import { Search, ClipboardList, Check, X, Cake } from "lucide-react";
...
const Dessert = () => {
  ...
  // Filter items for Dessert category (category ID = 4)
  const dessertItems = menuItems.filter((item) => item.category === 4);
    ...
    <div className="p-6 lg:h-[calc(100vh-100px)] flex flex-col">
      <div className="mb-6 flex-shrink-0">
        <h2 className="text-2xl font-bold text-secondary flex items-center">
          <Cake className="inline mr-2 text-primary" size={24} /> Dessert Items
        </h2>
        <p className="text-sm text-gray-500">
          Browse and add dessert items to your selection
        </p>
      </div>
