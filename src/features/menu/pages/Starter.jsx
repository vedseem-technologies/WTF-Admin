...
import { Search, ClipboardList, Check, X, Salad } from "lucide-react";
    ...
    <div className="p-6 lg:h-[calc(100vh-100px)] flex flex-col">
      <div className="mb-6 flex-shrink-0">
        <h2 className="text-2xl font-bold text-secondary flex items-center">
          <Salad className="inline mr-2 text-primary" size={24} /> Starter Items
        </h2>
        <p className="text-sm text-gray-500">
          Browse and add starter items to your selection
        </p>
      </div>
